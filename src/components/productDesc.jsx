...
import { selectedProducts, deleteProduct } from "../redux/actions/actions";
...
const CardsDescription = () => {
  ...
  const fetchProductDesc = async (id) => {
    try {
  ...
  const { id, title, price, description, image, rating, category } = productDesc;
  return (
    <>
    ...
    <div className="w-full h-screen opacity-60 flex justify-center items-center">
      ...
      <section id={id} className="text-gray-600 body-font overflow-hidden">
            ...
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              ...
              <div className="flex mb-4">
                <span className="flex items-center">
                  ...
                  <span className="text-gray-600 ml-3">4.4</span>
                </span>
